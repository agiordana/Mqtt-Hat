...
public:
	...
	*/
    ...
    static bool isfile(std::string&, std::string);
    static bool isfile(std::string&);
    static bool isdir(std::string&);
    static bool matchfile(std::string, std::string);
    static std::string matchfile(std::string);
    static std::string extractBin(std::string);
};
